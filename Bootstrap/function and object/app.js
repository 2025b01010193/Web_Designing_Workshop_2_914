...
// It loops through each elements
//Applies a function to each elements
//Return a new array
//let newarray = [1, 2, 3, 4, 5];
...
//if supplied and currentValue is the current value
let sum = [1, 2, 3, 4, 5];
let total = 
sum.reduce((accumulator, currentValue) => accumulator + currentValue, 0);
console.log(total);//15

//map reduce filter on object subject marks
let student =[
    { name: "Alice", marks: 85},
    { name: "Bob", marks: 92},
...
let totalMarks = students.reduce((acc,studenrs) => acc + student.marks,0);
